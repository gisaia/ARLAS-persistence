...
#########################################
usage(){
	echo "Usage: ./release.sh -api-major=X -api-minor=Y -api-patch=U -dev=Z+1 [--no-tests] [--skip-api]"
...
#### Setting versions ###################
#########################################
export ARLAS_persistence_VERSION="${API_MAJOR_VERSION}.${API_MINOR_VERSION}.${API_PATCH_VERSION}"
